...
Category.create(name: "Cardboard", video: "https://www.youtube.com/watch?v=Rlvd-dIAHCE&t=3s", description:  ["Cardboard egg cartons", "Cardboard trays", "Smooth cardboard (food and shoe boxes, tubes, file folders, cardboard from product packaging)", "Pizza boxes (remove and discard soiled liner; recycle little plastic supporter with rigid plastics)", "Paper cups (waxy lining ok if cups are empty and clean; recycle plastic lids with rigid plastics)", "Corrugated cardboard boxes (flattened and tied together with sturdy twine)", "To find a public recycling bin in your borough, use the Recycling Sites tab on the nav bar above.", "Cardboard"], image: "https://www.homelectrical.com/sites/default/files/styles/original_image/public/images/product/blg/blg-cardboard_recycle_diy.jpg")
...
Category.create(name: "Cartons", video: "https://www.youtube.com/watch?v=BrdK-0Mmgig", description: ["Food and beverage cartons", "Drink boxes", "Aseptic packaging (holds beverages and food: juice, milk and non-dairy milk products, soup, etc.)", "To find a public recycling bin in your borough, use the Recycling Sites tab on the nav bar above."], image: "https://mydisposal.com/wp-content/uploads/2019/03/Carton_recycle_Multi_Carton.jpg")
Category.create(name: "Metal", video: "https://www.youtube.com/watch?v=0jdAF4rOQ8w", description: ["Metal cans (soup, pet food, empty aerosol cans, empty paint cans, etc.)", "Aluminum foil and foil products (wrap and trays)", "Metal caps and lids", "Household metal items (wire hangers, pots, tools, curtain rods, small appliances that are mostly metal, certain vehicle license plates, etc.)", "Bulky metal items (large metal items, such as furniture, cabinets, large mostly metal appliances, DOES NOT INCLUDE electronic devices banned from disposal)", "To find a public recycling bin in your borough, use the Recycling Sites tab on the nav bar above."], image: "https://www.martinsrecycling.com/uploads/3/1/3/1/31310199/aluminum_orig.png")
Category.create(name: "Plastic (rigid plastic only)", video: "https://www.youtube.com/watch?v=zOy1wZvrEzE", description: ["Rigid plastic is any item that is mostly plastic resin—it is relatively inflexible and maintains its shape or form when bent.", "Plastic bottles, jugs, and jars", "Rigid plastic caps and lids", "Rigid plastic food containers (yogurt, deli, hummus, dairy tubs, cookie tray inserts, “clamshell” containers, other rigid plastic take-out containers)", "Rigid plastic non-food containers (such as “blister-pack” and “clamshell” consumer packaging, acetate boxes)", "Rigid plastic housewares (flower pots, mixing bowls, plastic appliances, etc.)", "Bulk rigid plastic (crates, buckets, pails, furniture, large toys, large appliances, etc.)", "To find a public recycling bin in your borough, use the Recycling Sites tab on the nav bar above."], image: "https://www.oregonmetro.gov/sites/default/files/styles/facebook_preview/public/2019/06/13/plastic-containers-for-recycling.jpg?itok=h2UbJar3")
Category.create(name: "Glass", video: "https://www.youtube.com/watch?v=k4tuEXx1iFk", description: ["Glass bottles and jars only.", "To find a public recycling bin in your borough, use the Recycling Sites tab on the nav bar above."], image: "http://prc.org/app/uploads/2019/01/glass.png")
Category.create(name: "Electronics", video: "https://www.youtube.com/watch?v=ZxdhG1OhVng", description: ["Electronics, such as computers, televisions, cellphones, power tools, electric razors and cameras, cannot be thrown away or recycled. They should be taken back to the retailers, which are required to accept them. They can also be taken to an Electronics Drop-Off Site. To find an Electronics Drop-Off Location in your borough, use the Recycling Sites tab on the nav bar above."], image: "https://www.staples.com/sbd/cre/noheader/sustainability-center/recycling-services/electronics/images/electronics.png")
Category.create(name: "Textiles", video: "https://www.youtube.com/watch?v=BUcCadqAtvM", description: ["Textiles, such as fabrics, clothing, shoes, blankets, towels, coats, and bedding can be dropped off for textile recycling or donation at any of the Textile Drop-Off Locations in New York City. To find a Textile Drop-Off Location in your borough, use the Recycling Sites tab on the nav bar above."], image: "http://www.acua.com/uploadedImages/Site/Blog/ACUA_Blog/clothingpile.jpg")
